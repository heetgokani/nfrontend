...
const InstagramSection = () => {
  useEffect(() => {
    // Re-triggers the Slick initialization for the gallery slider
    const initSlider = () => {
      if (window.$ && window.$.fn.slick) {
        const $slider = window.$(".common-slider");
  ...
  // Professional Sneaker Gallery Images from Unsplash
  const galleryImages = [
        ...
        <div className="container">
          <div className="section-header text-center">
            ...
            <p className="section-subheading">
              See how our customers styled shoe products on their feet
            </p>
          </div>
          <div className="instagram-container position-relative mt-48">
            ...
            >
              {galleryImages.map((src, index) => (
                <div key={index} className="instagram-slick-item">
                  <div className="instagram-card">
                    <div
                      className="instagram-img-wrapper"
                      style={{ cursor: "default" }}
                    >
                      <img
                        src={src}
                        alt={`Sneaker gallery ${index + 1}`}
                        className="instagram-card-img rounded"
                        style={{
                          objectFit: "cover",
                          width: "100%",
                          height: "250px",
