...
const CreateAttribute = () => {
  ...
  const fetchAttributes = async () => {
    try {
      const res = await axios.get(
        "https://nbackend-31lg.onrender.com/api/attributes"
      );
    ...
    setTerms(
      attr.terms.map((t) => ({
        ...
        imagePreview: t.image
          ? `https://nbackend-31lg.onrender.com${t.image}`
          : "",
        image: t.image || "",
        label: t.label || "",
      }))
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      if (editId) {
        await axios.put(
          `https://nbackend-31lg.onrender.com/api/attributes/${editId}`,
          formData,
        ...
        await axios.post(
          "https://nbackend-31lg.onrender.com/api/attributes/create",
          formData,
          { headers: { "Content-Type": "multipart/form-data" } }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `https://nbackend-31lg.onrender.com/api/attributes/${id}`
      );
                  ...
                  {attr.terms.map((t) => (
                    ...
                    >
                      ...
                      {attr.type === "image" && t.image && (
                        <img
                          src={`https://nbackend-31lg.onrender.com${t.image}`}
                          style={{
                            width: "20px",
                            height: "20px",
                            borderRadius: "4px",
