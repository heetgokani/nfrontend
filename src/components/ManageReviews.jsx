...
const ManageReviews = () => {
  ...
  const loadReviews = async () => {
    try {
      ...
      const res = await axios.get(
        "https://nikam-ecom-backend.onrender.com/api/reviews/admin/all"
      );
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      await axios.put(
        `https://nikam-ecom-backend.onrender.com/api/reviews/${id}/status`,
        {
          status: newStatus,
        }
      );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this review?")) {
      try {
        await axios.delete(
          `https://nikam-ecom-backend.onrender.com/api/reviews/${id}`
        );
