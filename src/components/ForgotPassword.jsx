...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      await axios.post(
        "https://nbackend-31lg.onrender.com/api/user/forgot-password-otp",
        {
          email,
        }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://nbackend-31lg.onrender.com/api/user/reset-password",
      ...
      <div className="breadcrumb-wrapper d-none d-md-block">
        <div className="universal-container">
          <ul className="list-unstyled d-flex align-items-center m-0 breadcrumb-list">
            ...
            <li>
              <NavLink to="/login" className="breadcrumb-link">
                Login
              </NavLink>
            </li>
            <li className="d-flex align-items-center">
            ...
            <li className="breadcrumb-current">Forgot Password</li>
          </ul>
        </div>
      </div>
              ...
              <div className="login-card">
                <div className="text-center mb-5">
                  ...
                  <p className="login-subtitle">
                    {otpSent
                      ? "Enter the OTP sent to your email to create a new password."
