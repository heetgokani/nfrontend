...
const Createfaq = () => {
  ...
  const fetchFaqs = async () => {
    const res = await axios.get(
      "https://nbackend-31lg.onrender.com/api/faq/all"
    );
    setFaqs(res.data);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://nbackend-31lg.onrender.com/api/faq/update/${editingId}`,
          formData
        );
        toast.success("FAQ Updated");
      } else {
        await axios.post(
          "https://nbackend-31lg.onrender.com/api/faq/add",
          formData
        );
  ...
  const handleDelete = async (id) => {
    ...
    await axios.delete(
      `https://nbackend-31lg.onrender.com/api/faq/delete/${id}`
    );
