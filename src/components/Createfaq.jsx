...
const Createfaq = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://nikam-ecom-backend.onrender.com/api/faq/update/${editingId}`,
          formData
        );
        toast.success("FAQ Updated");
      } else {
        await axios.post(
          "https://nikam-ecom-backend.onrender.com/api/faq/add",
          formData
        );
  ...
  const handleDelete = async (id) => {
    ...
    await axios.delete(
      `https://nikam-ecom-backend.onrender.com/api/faq/delete/${id}`
    );
