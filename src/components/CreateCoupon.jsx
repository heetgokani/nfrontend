...
const CreateCoupon = () => {
  ...
  const fetchInitialData = async () => {
    try {
      const [couponRes, catRes, prodRes] = await Promise.all([
        axios.get("https://nbackend-31lg.onrender.com/api/coupons/all"),
        axios.get("https://nbackend-31lg.onrender.com/api/category/all"),
        axios.get("https://nbackend-31lg.onrender.com/api/products"),
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(
          `https://nbackend-31lg.onrender.com/api/coupons/update/${editId}`,
          formData
        );
        toast.success("Coupon Updated");
      } else {
        await axios.post(
          "https://nbackend-31lg.onrender.com/api/coupons/create",
          formData
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `https://nbackend-31lg.onrender.com/api/coupons/delete/${id}`
      );
