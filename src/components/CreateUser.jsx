...
// 'https://nikam-ecom-backend.onrender.com' to 'https://www.avsarcards.com' so it doesn't fail.
const API_URL_ROLES = "https://nikam-ecom-backend.onrender.com/api/role";
const API_URL_USER = "https://nikam-ecom-backend.onrender.com/api/user";
